...
extension UITabBarController {
    fileprivate struct AssociatedKey {
        static var bulgeOffsetY: String = "com.tabBarController.bulgeOffsetY"
    }
    ...
    public func add<T: UINavigationController>(child controller: UIViewController,
        ...
        if let selectImageName = selectImageName {
            ...
            if #available(iOS 10.0, *) {
                ...
                let unselectedTintColor: UIColor! = tabBar.appearance?.unselectedTintColor ?? tabBar.tintColor
                // 未选中状态下的图片
